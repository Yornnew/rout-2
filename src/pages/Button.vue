...
<!--Card1-->
    ...
    <a href="#" class="max-w-sm block rounded-md border border-gray-300 p-4 shadow-sm sm:p-6">
...
export default {
  async mounted() {
    //call API , fetch data from backend
    const response = await axios.get('https://api.github.com/users/yorn-bit/repos')

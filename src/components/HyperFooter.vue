<template>
  <footer class="bg-black p-4">
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 pt-1">
      <div class="lg:flex lg:items-center lg:justify-center lg:gap-8">
        <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
          ...
          <ul class=" col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-center">
            <li>
              <a
                href="#"
                rel="noreferrer"
                target="_blank"
                class="text-gray-300 transition hover:opacity-75 dark:text-gray-200"
              >
      ...
      <div class="mt-8 border-t border-gray-100 pt-8 dark:border-gray-800">
        <div class="sm:flex sm:justify-between">
          <p class="text-xs text-gray-200 dark:text-gray-400">
            &copy; 2022. Yorn|Porfolio. All rights reserved.
          </p>
  
          <ul class="mt-8 flex flex-wrap justify-start gap-4 text-xs sm:mt-0 lg:justify-end">
            <li>
              <a href="#" class="text-gray-200 transition hover:opacity-75 dark:text-gray-400">
                Terms & Conditions
              </a>
            </li>
